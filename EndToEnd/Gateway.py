...
#         starting_price = self.df['Close'][0]
...
#         market_data = {'Ticker': self.ticker, 'Bids':bids, 'Asks': asks, 'Last Price': starting_price, 'Volume': random.randint(100,10000)}
...
df = pd.read_csv(f'{base}cleaned/AAPL_7d.csv')
ticker = 'AAPL'
